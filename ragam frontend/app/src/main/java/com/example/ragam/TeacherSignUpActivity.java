...
public class TeacherSignUpActivity extends AppCompatActivity {
    ...
    private EditText fullNameInput, emailInput, phoneInput, passwordInput, confirmPasswordInput, experienceInput, specializationInput;
    ...
    private void performRegistration() {
        ...
        if (specialization.isEmpty()) {
            specializationInput.setError("Specialization is required");
            return;
        }
        ...
        if (!experienceStr.isEmpty()) {
            try {
                ...
                if (experience < 0 || experience > 60) {
                    experienceInput.setError("Years of experience must be between 0 and 60");
                    return;
                }
            } catch (NumberFormatException e) {
                experienceInput.setError("Please enter a valid number");
                return;
            }
        }
        ...
        apiHelper.register(email, password, fullName, "teacher", phone, "", experience, specialization, new ApiHelper.ApiCallback() {
            @Override
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        if (isSuccess) {
                            ...
                            Toast.makeText(TeacherSignUpActivity.this, "Account created successfully! Please sign in with your credentials.", Toast.LENGTH_LONG).show();
                            
                            // Redirect to login page
                            Intent intent = new Intent(TeacherSignUpActivity.this, TeacherSignInActivity.class);
                        ...
                        Log.e("TeacherSignUp", "Error parsing response", e);
                        Log.e("TeacherSignUp", "Response was: " + response);
                        Toast.makeText(TeacherSignUpActivity.this, "Registration failed. Please try again.", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onError(String error) {
                runOnUiThread(() -> {
                    Toast.makeText(TeacherSignUpActivity.this, error, Toast.LENGTH_SHORT).show();
                    signUpButton.setEnabled(true);
                    signUpButton.setText("SIGN UP");
                });
            }
